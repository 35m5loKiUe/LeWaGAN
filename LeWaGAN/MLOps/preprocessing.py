import tensorflow
from LeWaGAN.MLOps.params import IMAGE_SIZE, ROOT_PATH, DATA_PATH, DATA_LOCATION
import os

#Create a dataset from a local directory
def create_dataset(data_location = DATA_LOCATION, image_size=(IMAGE_SIZE, IMAGE_SIZE), labels=None, color_mode='rgb', batch_size=32,
                     validation_split=0.) :
    ...
    if data_location == 'LOCAL' :
        ...
        dataset = tensorflow.keras.utils.image_dataset_from_directory(path, color_mode=color_mode,
